...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "butterflys", // required by Discord API, not shown in the client
        state: "/butterflys",     // this is what people actually see
        type: 4,               // Custom
      },
    ],
  },
